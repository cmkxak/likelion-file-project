...
class HospitalParserTest {
    ...
    void id_test(){
        ...
        Hospital hospital = hospitalParser.parse(str2);
    ...
    void district_test(){
        ...
        assertEquals(district, hospitalParse.getDistrict());
    }
    ...
    void category_test() {
        ...
        String category = "C";
        Hospital hospitalParse = hospitalParser.parse(str2);
        assertEquals(category, hospitalParse.getCategory());
    }

    @Test
    void emergencyRoom_test(){
        Integer emergencyRoomStatus = 2;
        HospitalParser hospitalParser = new HospitalParser();

        Hospital hospitalParse = hospitalParser.parse(str2);
        assertEquals(emergencyRoomStatus, hospitalParse.getEmergencyRoom());
    }
    ...
    void name_test() {
        ...
        String name = "가산기대찬의원";
        Hospital hospitalParse = hospitalParser.parse(str2);
        assertEquals(name, hospitalParse.getName());
    }
}